...
public class ErrorDto extends BaseDto{
    ...
    public final static ErrorDto telematicDeviceIdNotFound = ErrorDto.builder().code(2001).message("The ITSS_TelematicsDeviceID could not be found").build();
    public final static ErrorDto invalidTelematicDeviceId = ErrorDto.builder().code(2002).message("The ITSS_TelematicsDeviceID format is not specification compliant").build();
    public final static ErrorDto transportDeviceIdNotFound = ErrorDto.builder().code(2003).message("The ITSS_TransportDeviceID could not be found").build();
    public final static ErrorDto invalidTransportDeviceId = ErrorDto.builder().code(2004).message("The ITSS_TransportDeviceID format is not specification compliant").build();
    public final static ErrorDto telematicAndTransportDeviceIdNotPaired = ErrorDto.builder().code(2005).message("The ITSS_TelematicsDeviceID and the ITSS_TransportDeviceID are not paired.").build();
    ...
    public final static ErrorDto missingTelematicDeviceId = ErrorDto.builder().code(2009).message("The parameter ITSS_TelematicsDeviceID is missing.").build();
    public final static ErrorDto missingTransportDeviceId = ErrorDto.builder().code(2010).message("The parameter ITSS_TransportDeviceID is missing.").build();
